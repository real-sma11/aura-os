...
/**
 * Small four-pointed sparkle glyph painted next to the bottom-taskbar
 * user name for paid subscribers. The SVG fill resolves to
 * `currentColor`, and `.badge[data-plan="..."]` re-binds `color` to
 * the theme-aware `--color-plan-pro` / `--color-plan-crusader` /
 * `--color-plan-sage` tokens defined in `interface/src/index.css` (so
 * the badge tints automatically follow dark/light theme flips without
