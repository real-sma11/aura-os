...
pub(crate) use classifiers::{
    ...
    is_rate_limited_failure, is_truncation_failure, looks_like_unclassified_transient,
    should_restart_on_error_event,
};
...
pub(crate) use push_failures::{
    ...
    classify_push_failure, max_dod_retries_per_task, push_failure_reset_rearms_stuck_emission,
    recovery_checkpoint, should_task_complete_despite_push_failure,
